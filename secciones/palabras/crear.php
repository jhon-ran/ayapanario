...
if($_POST){
        ...
        if(empty($errores)){
                ...
                $sentencia = $conexion->prepare("INSERT INTO palabras(id,ayapaneco,variante,afi,significado,ejemplo_aya,ejemplo_esp,raiz) 
                VALUES (null, :ayapaneco, :variante, :afi, :significado, :ejemplo_aya, :ejemplo_esp, :raiz)");
